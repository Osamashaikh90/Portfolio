      ...
      <div className='col-span-1 mobile:col-start-3 mobile:col-end-9 mt-6'>
        <div className='flex gap-5 px-2 items-center flex-wrap mobile:flex-nowrap justify-start'>
          ...
          <input type="search" name="projects" id="" className='bg-inherit border border-[#363a40] w-full mobile:w-[55%] py-[6px] text-sm h-[34px] px-[10px] text-[#7d8590] rounded-md focus:ring-blue-600 outline-blue-600' placeholder='Find a project..' onChange={(e) => setSearch(e.target.value)}/>
            ...
            <span><button className='flex items-center gap-1 border border-[#2b2e33] rounded-md bg-[#383a3d59] py-[5px] px-3 mobile:px-5 w-full text-[#c9d1d9] text-sm font-medium hover:border-[#6c717b] hover:bg-[#54575b62]' onClick={handleClickType}>Type <span className="mt-1"><TiArrowSortedDown /></span></button>
            ...
            <span className='relative'><button className='flex items-center gap-1 border border-[#2b2e33] rounded-md bg-[#383a3d59] py-[5px] px-3 mobile:px-5 w-full text-[#c9d1d9] text-sm font-medium hover:border-[#6c717b] hover:bg-[#54575b62]' onClick={handleClickLang}>Language <span className="mt-1"><TiArrowSortedDown /></span>
            </button>
            ...
            <span><button className='flex items-center gap-1 border border-[#2b2e33] rounded-md bg-[#383a3d59] py-[5px] px-3 mobile:px-5 w-full text-[#c9d1d9] text-sm font-medium hover:border-[#6c717b] hover:bg-[#54575b62]' onClick={handleClickSort}>Sort <span className="mt-1"><TiArrowSortedDown /></span></button>
         ...
         <span className='hidden mobile:block'> <button className=' rounded-md hover:bg-[#388BFD] bg-[#1f6feb]  py-[5px] px-3  text-[#e6edf3] font-medium hover:border-[#6c717b]  flex items-center gap-1'><GoRepo className="font-semibold" /> New</button></span>
          </div>
          <div>
          {originalData
