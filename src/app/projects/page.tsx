...
const sortData = () => {
  ...
  return (
    <div className='text-white mx-5 sm:mx-24 grid gap-5 grid-cols-1 sm:grid-cols-8'>
      <HeroProfile />
      <div className='col-span-1 sm:col-start-3 sm:col-end-9 mt-6'>
        <div className='flex gap-6 px-2 items-center flex-wrap sm:flex-nowrap justify-start'>
                    <button className=' rounded-md bg-[#1f6feb] py-[5px] px-3 w-full sm:hidden hover:bg-[#388BFD] text-[#e6edf3] font-medium hover:border-[#6c717b]  flex items-center justify-center gap-1'><GoRepo className="font-semibold" /> New</button>
          <input type="search" name="projects" id="" className='bg-inherit border border-[#363a40] w-full sm:w-[55%] py-[6px] text-sm h-[34px] px-[10px] text-[#7d8590] rounded-md focus:ring-blue-600 outline-blue-600' placeholder='Find a project..' onChange={(e) => setSearch(e.target.value)}/>
            <div className='flex gap-1 mt-[-10px] sm:mt-0'>
            <span><button className='flex items-center gap-1 border border-[#2b2e33] rounded-md bg-[#383a3d59] py-[5px] px-3 sm:px-5 w-full text-[#c9d1d9] text-sm font-medium hover:border-[#6c717b] hover:bg-[#54575b62]' onClick={handleClickType}>Type <span className="mt-1"><TiArrowSortedDown /></span></button>
            ...
            <span className='relative'><button className='flex items-center gap-1 border border-[#2b2e33] rounded-md bg-[#383a3d59] py-[5px] px-3 sm:px-5 w-full text-[#c9d1d9] text-sm font-medium hover:border-[#6c717b] hover:bg-[#54575b62]' onClick={handleClickLang}>Language <span className="mt-1"><TiArrowSortedDown /></span>
            </button>
            ...
            <span><button className='flex items-center gap-1 border border-[#2b2e33] rounded-md bg-[#383a3d59] py-[5px] px-3 sm:px-5 w-full text-[#c9d1d9] text-sm font-medium hover:border-[#6c717b] hover:bg-[#54575b62]' onClick={handleClickSort}>Sort <span className="mt-1"><TiArrowSortedDown /></span></button>
         ...
         <span className='hidden sm:block'> <button className=' rounded-md hover:bg-[#388BFD] bg-[#1f6feb]  py-[5px] px-3  text-[#e6edf3] font-medium hover:border-[#6c717b]  flex items-center gap-1'><GoRepo className="font-semibold" /> New</button></span>
          </div>
          <div>
          {originalData
