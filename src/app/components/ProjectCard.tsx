...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
    ...
    return (
      ...
      <Image
                            ...
                            height={260}
                alt="profile" />
        <Link href={project.live_link} target='_blank'>        <div className="overlay absolute left-8 right-[30px] top-4 bottom-6  inset-0 opacity-0 transition-opacity duration-400 ease-in-out bg-[#0d1117] cursor-pointer group-hover:opacity-80 group-hover:rounded">
