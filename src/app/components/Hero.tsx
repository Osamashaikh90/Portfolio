...
const Hero = () => {
  ...
  return (
      ...
      <HeroProfile/>
      <div className='col-span-1 mobile:col-start-3 mobile:col-end-9 h-full  border border-[#2b2e33] mt-[34px] mx-1 px-2 rounded-[6px]'>
        ...
        <div className='flex justify-center flex-col relative h-[50vh] px-3'>
          ...
          <div className="foreground flex justify-start items-center  z-[2] text-[#f9826c]">
            <div className="content px-3 pt-10 flex flex-col gap-y-5 ">
              ...
              <h1 className='name text-[#e6edf3] text-5xl font-medium mb-2 uppercase font-sans '><span className='text-[#ff5f9e] leading-normal mobile:leading-none '>I am  </span>Osama Shaikh</h1>
        ...
        <div className='flex items-center justify-center flex-col gap-y-4 mt-2'>
          ...
          <div className='w-[90%] h-[1px] bg-[#2b2e33]'></div>
            <div className='flex gap-5 mobile:gap-40 items-center flex-wrap justify-center mobile:justify-between'>
...
<a href="mailto:shaikhosama499@gmail.com"><img src="https://img.shields.io/badge/mail-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/></a>
          ...
          <h3 className='font-sign mobile:hidden'>© {year} <span className='font-sign'>Osama Shaikh</span></h3>
          </div> 
          </div>
      </div>
      <ReactTooltip
