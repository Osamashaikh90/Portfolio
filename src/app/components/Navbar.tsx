      ...
      <>
            <div className='h-[108px] flex  items-center justify-center flex-col border-y border-[#21262D] text-[#e6edf3] bg-[#010409]'>
                <div className='p-3 flex items-center justify-between w-full '>
                    ...
                    <div className="right flex gap-[5px] sm:gap-[10px] justify-end sm:justify-between items-center w-[32%] mobile:w-[40%] ">
                        <div className='text-[#7d8590] text-xl border border-[#363a40] rounded-md w-[25%] sm:w-[70%]  flex items-center p-1 gap-1 hover:border-[#6c717b] active:border-[#363a40]'>
                            <span className='text-[#7d8590] text-lg px-1 '><FiSearch /></span>
                            <input
                                 onClick={(e)=> setDisabled(!isDisabled)}
                                    disabled={isDisabled}
                                type="search" name="search" id="" className='w-0 sm:w-[90%] bg-inherit border-0 !outline-none text-base font-extralight disabled ' placeholder='Type here to search' /><span className='text-[#454b55] text-lg hidden sm:block'>|</span><span className='hidden sm:block'><GoCommandPalette/></span></div>
                        <span className='text-[#454b55] text-2xl hidden sm:block'>|</span>
                        <span className='hidden sm:block'><span className='text-[#7d8590] text-xl border border-[#363a40] rounded-md p-[6px] flex gap-1 hover:border-[#6c717b] active:border-[#363a40] hover:bg-[#54575b62] cursor-pointer '><BiPlus /><TiArrowSortedDown /></span></span>
                        <span className='text-[#7d8590] text-2xl border border-[#363a40] rounded-md p-1 hover:border-[#6c717b] hover:bg-[#54575b62] cursor-pointer hidden sm:block'><LiaDotCircle/></span>
                        <span className='text-[#7d8590] text-2xl border border-[#363a40] rounded-md p-1 hover:border-[#6c717b] hover:bg-[#54575b62] cursor-pointer hidden sm:block'><BiGitPullRequest/></span>
                ...
                <div className='p-2 flex justify-between items-center w-full relative'>
                    ...
                    <Link className='hidden sm:block' href="/about"><li className='flex gap-2 items-center  hover:bg-[#21262d8f] hover:rounded-md p-1 relative'><span className={`text-lg text-[#7d8590] font-semibold ${pathname === '/about' ? 'after:content-[""] after:absolute after:h-[2px] after:w-full after:bg-[#F78166] after:left-0 after:top-full after:rounded-lg after:block' : ''}`}><GoStar className="font-bold"/></span><span className=' text-[#e6edf3] text-sm'>About</span></li></Link>
                       <a className='hidden sm:block' href="https://dev-diaries-kappa.vercel.app/"><li className='flex gap-2 items-center  hover:bg-[#21262d8f] hover:rounded-md p-1'><span className='text-lg text-[#7d8590] font-semibold'><GoPackage className="font-bold"/></span><span className=' text-[#e6edf3] text-sm'>Blogs</span></li></a> 
                ...
                <CgGitFork />{" "}<AiFillStar />
                    ...
                    <div className='sm:hidden text-xl   relative text-[#7d8590] mr-2 flex items-center  rounded-[3px]'>
