            ...
            <div className='h-[108px] flex  items-center justify-center flex-col border-y border-[#21262D] text-[#e6edf3] bg-[#010409]'>
                ...
                <div className='p-2 flex justify-between items-center w-full relative'>
                    ...
                    <Link className='hidden mid:block' href="/about"><li className='flex gap-2 items-center  hover:bg-[#21262d8f] hover:rounded-md p-1 relative'><span className={`text-lg text-[#7d8590] font-semibold ${pathname === '/about' ? 'after:content-[""] after:absolute after:h-[2px] after:w-full after:bg-[#F78166] after:left-0 after:top-full after:rounded-lg after:block' : ''}`}><GoStar className="font-bold"/></span><span className=' text-[#e6edf3] text-sm'>About</span></li></Link>
                       <a className='hidden midp:block' href="https://dev-diaries-kappa.vercel.app/"><li className='flex gap-2 items-center  hover:bg-[#21262d8f] hover:rounded-md p-1'><span className='text-lg text-[#7d8590] font-semibold'><GoPackage className="font-bold"/></span><span className=' text-[#e6edf3] text-sm'>Blogs</span></li></a> 
