                        ...
                        <div className='text-[#7d8590] text-xl border border-[#363a40] rounded-md w-[25%] mobile:w-[70%]  flex items-center p-1 gap-1 hover:border-[#6c717b] active:border-[#363a40]'>
                            ...
                            <input
                                 onClick={(e)=> setDisabled(!isDisabled)}
                                    disabled={isDisabled}
                                type="search" name="search" id="" className='w-0 mobile:w-[90%] bg-inherit border-0 !outline-none text-base font-extralight disabled ' placeholder='Type here to search' /><span className='text-[#454b55] text-2xl hidden mobile:block'>|</span><span className='hidden mobile:block'><GoCommandPalette/></span></div>
