...
const HeroProfile = () => {
 const handleHireButtonClick = () => {
  ...
  return (
    <>
      <div className='col-span-1 md:col-start-1 md:col-end-3'>
 ...
 <Image
       ...
       <div  className=" md:hidden cursor-pointer emoji bg-[##0d1117] border border-[#21262D] w-full rounded-lg mt-5 px-2 py-[6px] text-sm">😄 <span className='text-[#e6edf3]'>learning!</span></div>
