...
const About = () => {
  ...
  return (
    <div className='text-white mx-4 sm:mx-8 md:mx-24 '>
      <div className='w-full  flex flex-wrap items-center justify-center  gap-5 md:gap-24 p-5'>
        ...
        <div className=''><Image className='md:hidden mt-[-20px] md:mt-0 rounded-full grayscale hover:grayscale-0 transition-all duration-700'
      ...
      <div className='my-5 grid grid-cols-1 md:grid-cols-2 gap-8 '>
        ...
        <div className='outer '>
          <div className='tab'>
            <div className='buttons flex gap-14 md:gap-12 cursor-pointer items-center justify-center'>
              <span className={`flex items-center gap-1 hover:text-[#a2a9b4] ${activeTab === 'Qualification' ? ' ' : 'text-[#a2a9b4] animate-bounce'}`} onClick={() => handleTabChange('Qualification')}><FaGraduationCap />Qualification</span>
              <span className={`flex items-center gap-1 hover:text-[#a2a9b4] ${activeTab === 'Work Experience' ? ' ' : 'text-[#a2a9b4] animate-bounce'}`} onClick={() => handleTabChange('Work Experience')}><MdWork />Work-Experience</span></div></div>
          <div className='section  '>
            {/* --qualification-- */}
            {activeTab === 'Qualification' && (
              <div className="data mx-10 md:mx-24 mt-5   grid-container relative ">
            ...
            {activeTab === 'Work Experience' && (
              <div className="data mx-8 md:mx-24 mt-5  grid-container relative ">
